...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~Team #Venus Bot~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  Team #Venus Bot " ] servers! [ " ${client.guilds.size} " ] Users! [ " ${client.users.size} " ]`); 
...
client.on('message' , message => {
        ...
        client.channels.get("454724311194927114").send(
            "\n" + "**" + " ● Suggested By : " + "**" +
            "\n" + "**" + "» " + message.author.tag + "**" +
            "\n" + "**" + " ● Suggest : " + "**" +
            "\n" + "**" + args + "**")
...
client.on('message', message => {
    ...
    if (message.content === "Venus Bot") {
        ...
        message.edit('**Team**')
        message.edit('**Team V**')
        message.edit('**Team Ve**')
        message.edit('**Team Ven*')
        message.edit('**Team Venu**')
        message.edit('**Team Venus **')
        message.edit('**Team Venus B**')
        message.edit('**Team Venus Bo**')
        message.edit('**Team Venus Bot**')
        message.edit('**Team Venus Bot **')
        message.edit('**Team Venus Bot ..**')
        }, 1000)
    }
...
client.on('message' , message => {
 ...
 .setURL('https://discordapp.com/oauth2/authorize?client_id=520714082970632232&scope=bot&permissions=9')
  message.channel.sendEmbed(embed);
   }
});
client.on('message' , message => {
...
client.on("guildCreate", guild => {
client.channels.get("454724311194927114").send(' ***  BOT  ***   **Join To**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
});

client.on("guildDelete", guild => {
client.channels.get("454724311194927114").send(' ***  BOT  ***   **Leave From**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
});
...
if (message.content === (prefix + "support")) {
     message.author.send('https://discord.gg/s5ATDeu').catch(e => console.log(e.stack));
    }
   } 
  });
...
if (message.author.id !== '454724311194927114','510925297936236545') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
